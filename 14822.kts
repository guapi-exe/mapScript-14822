...
val url = ""
val mapScriptupdate by lazy { Vars.state.rules.tags.getLong(url) }
            ...
            "${Blocks.salvo.emoji()}\n500￥" to {
                if(getteammoney()>=500) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金500￥放置了炮塔${Blocks.salvo.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.salvo.emoji()}但队伍资金不足")
                        }
                    }
                }
            },"${Blocks.lancer.emoji()}\n500￥" to {
                if(getteammoney()>=500) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金500￥放置了炮塔${Blocks.lancer.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.lancer.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=500) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金500￥放置了炮塔${Blocks.scatter.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.scatter.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.diffuse.emoji()}\n1000￥" to {
                if(getteammoney()>=1000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金1000￥放置了炮塔${Blocks.diffuse.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.diffuse.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=1000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金1000￥放置了炮塔${Blocks.tsunami.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.tsunami.emoji()}但队伍资金不足")
                        }
                    }
                }
            },"${Blocks.ripple.emoji()}\n1000￥" to {
                if(getteammoney()>=1000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金1000￥放置了炮塔${Blocks.ripple.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.ripple.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.lustre.emoji()}\n3000￥" to {
                ...
                if(getteammoney()>=3000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金3000￥放置了炮塔${Blocks.sublimate.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.sublimate.emoji()}但队伍资金不足")
                        }
                    }
                }
            },"${Blocks.titan.emoji()}\n3000￥" to {
                if(getteammoney()>=3000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金3000￥放置了炮塔${Blocks.titan.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.titan.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.spectre.emoji()}\n6000￥" to {
                if(getteammoney()>=6000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金6000￥放置了炮塔${Blocks.spectre.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                ...
                if(getteammoney()>=6000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金6000￥放置了炮塔${Blocks.disperse.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.disperse.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=6000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金6000￥放置了炮塔${Blocks.afflict.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.afflict.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.foreshadow.emoji()}\n20000￥" to {
                if(getteammoney()>=20000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金20000￥放置了炮塔${Blocks.foreshadow.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.foreshadow.emoji()}但队伍资金不足")
                        }
                    }
                }
            },"${Blocks.scathe.emoji()}\n20000￥" to {
                if(getteammoney()>=20000) {
                    ...
                    tile1.setNet(Blocks.itemSource, team(), 0)
                    tile1.build.apply { configure(Items.carbide) }
                    delay(100)
                    tile1.setNet(Blocks.air, team(), 0)
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金20000￥放置了炮塔${Blocks.scathe.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.scathe.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=20000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金20000￥放置了炮塔${Blocks.meltdown.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.meltdown.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.smite.emoji()}\n80000￥" to {
                if(getteammoney()>=80000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金80000￥放置了炮塔${Blocks.smite.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.smite.emoji()}但队伍资金不足")
                        }
                    }
                }
            },"${Blocks.malign.emoji()}\n100000￥" to {
                if(getteammoney()>=100000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金100000￥放置了炮塔${Blocks.malign.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.malign.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "${Blocks.overdriveDome.emoji()}\n100000￥" to {
                if(getteammoney()>=100000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金100000￥放置了炮塔${Blocks.overdriveDome.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.overdriveDome.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=100000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金100000￥放置了炮塔${Blocks.shockwaveTower.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.shockwaveTower.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=100000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金100000￥放置了炮塔${Blocks.cryofluidMixer.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.cryofluidMixer.emoji()}但队伍资金不足")
                        }
                    }
                }
                ...
                if(getteammoney()>=100000) {
                    ...
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}消费队伍资金100000￥放置了炮塔${Blocks.neoplasiaReactor.emoji()}")
                        }
                    }
                }else{
                    Groups.player.each { p->
                        if(p.team() == team()){
                            sendMessage("玩家${name()}想要放置炮塔${Blocks.neoplasiaReactor.emoji()}但队伍资金不足")
                        }
                    }
                }
            }
        ...
        this += listOf(
            "[green]升级炮塔伤害当前${1+getteamturret()*0.05}->${1+(getteamturret()+1)*0.05}\n${((getteamturret()+1)*200)*(getteamturret()/4+1)}" to {
                if(getteammoney() > ((getteamturret()+1)*200)*(getteamturret()/4+1)) {
                    ...
                    for (player in Groups.player) {
                        if (team() == player.team()) {
                            sendMessage("玩家${name()}购买了炮塔伤害当前:${1+getteamturret()*0.05}")
                        }
                    }
                    UnitgradeMenu()
                }else {
                    for (player in Groups.player) {
                        if (team() == player.team()) {
                            sendMessage("玩家${name()}想要购买了炮塔伤害但队伍货币不足")
                        }
                    }
                    UnitgradeMenu()
                }
        ...
        this += listOf(
            "[green]购买核心生命${getteamlifes(team())+20}->${getteamlifes(team())+21}\n50000" to {
                if(getteammoney() > 50000) {
                    ...
                    for (player in Groups.player) {
                        if (team() == player.team()) {
                            sendMessage("玩家${name()}购买了核心生命当前:${getteamlifes(team())+21}")
                        }
                    }
                    UnitgradeMenu()
                }else {
                    for (player in Groups.player) {
                        if (team() == player.team()) {
                            sendMessage("玩家${name()}想要购买核心生命但队伍货币不足")
                        }
                    }
                    UnitgradeMenu()
                }
            ...
            this += listOf(
                "[green]升级我们对钻头的认知度当前:${getteamdrillgrade()}->${getteamdrillgrade()+1}级\n${Math.pow((5000 * getteamdrillgrade()).toDouble(), 1.2).toInt()}" to {
                    if (getteammoney() >= Math.pow((5000 * getteamdrillgrade()).toDouble(), 1.2)) {
                        ...
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("你们对钻头的认知度加深了等级当前:${getteamdrillgrade()}级")
                            }
                        }
                        UnitgradeMenu()
                    } else {
        ...
        this += listOf(
            "[red]抽取超级防御单位\n100000" to {
                if(getteammoney() >= 100000){
                    ...
                    for (player in Groups.player) {
                        if (team() == player.team()) {
                            sendMessage("玩家${name()}想要购买超级防御单位但队伍无法支撑")
                        }
                    }
                }
            }
            ...
            this += listOf(
                "${StatusEffects.overdrive.emoji()}\n20000" to {
                    if (getteammoney() >= 20000) {
                        ...
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}购买单位buff${StatusEffects.overdrive.emoji()}")
                            }
                        }
                        buffMenu()
                    } else {
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}想要购买buff${StatusEffects.overdrive.emoji()}但队伍货币不足")
                            }
                        }
                        buffMenu()
                    }
            ...
            this += listOf(
                "${StatusEffects.overclock.emoji()}\n30000" to {
                    if (getteammoney() >= 30000) {
                        ...
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}购买单位buff${StatusEffects.overclock.emoji()}")
                            }
                        }
                        buffMenu()
                    } else {
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}想要购买buff${StatusEffects.overclock.emoji()}但队伍货币不足")
                            }
                        }
                        buffMenu()
                    }
            ...
            this += listOf(
                "${StatusEffects.boss.emoji()}\n40000" to {
                    if (getteammoney() >= 40000) {
                        ...
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}购买单位buff${StatusEffects.boss.emoji()}")
                            }
                        }
                        buffMenu()
                    } else {
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}想要购买buff${StatusEffects.boss.emoji()}但队伍货币不足")
                            }
                        }
                        buffMenu()
                    }
            ...
            this += listOf(
                "${StatusEffects.shielded.emoji()}\n60000" to {
                    if (getteammoney() >= 60000) {
                        ...
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}购买单位buff${StatusEffects.shielded.emoji()}")
                            }
                        }
                        buffMenu()
                    } else {
                        for (player in Groups.player) {
                            if (team() == player.team()) {
                                sendMessage("玩家${name()}想要购买buff${StatusEffects.shielded.emoji()}但队伍货币不足")
                            }
                        }
                        buffMenu()
                    }
...
onEnable {
    ...
    contextScript<ContentsTweaker>().addPatch(
        "pvp",
        dataDirectory.child("contents-patch").child("14822.json").readString()
    )
}
//飞艇创创ai暂时改为适配无创创版本
        ...
        loop(Dispatchers.game) {
            ...
            Groups.player.each { p ->
                ...
                text += buildString {
                    ...
                    appendLine("[red]请不要拆除场上物品比如如果你们没又基础模块你们将无法获取超级单位")
                    ...
                    for(unitType in allattackunits){
                        ...
                        appendLine("[while]${unitType.emoji()}共${getteamunitlinenew(p.team(),unitType)}条产线")
                    }
                }
                Call.infoPopup(
                    p.con, text, 0.51f,
        ...
        loop(Dispatchers.game){
            ...
            for(team in teams) {
                if(teamOppressive.get(team) == largest) {
                    Groups.player.forEach { p ->
                        Call.setHudText(p.con, "为了获得最佳游戏体验请安装ct\n队伍[${team.color}]${team}对其他队伍的镇压度最高${teamOppressive.get(team)}获得大额增益")
                    }
